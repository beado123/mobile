...
### Login Page
Uses Basic OAuth(username and passwords) to login interact with github API.

<img src="app/img/IMG_1644.PNG" height="400">

### Profile Page
Shows basic information: number of followers, following, and repositries, create date of the user.
