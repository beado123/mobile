...
<img src="app/img/IMG_1694.PNG" height="400">       <img src="app/img/IMG_1695.PNG" height="400">

* When pressing the right button to unfollow the user, the text on the button changes to 'follow'. Can search the user by their names. Can sort users by the number of followers they have and create date. 
